JENKINS_DOCKER_AGENT_SECRET := be1d27a29051b6fd6ce9bf840af0da0da439f6bbb0eefd1bb3007e34b389ee6a
...
start-jenkins:
	...
	sleep 30
	docker run -d --rm --network jenkins --name jenkins-agent-python --init --env JENKINS_URL=http://jenkins-server:8080 --env JENKINS_AGENT_NAME=agent02 --env JENKINS_SECRET=$(JENKINS_PYTHON_AGENT_SECRET) --env JENKINS_AGENT_WORKDIR=/home/jenkins/agent jenkins-agent-python
